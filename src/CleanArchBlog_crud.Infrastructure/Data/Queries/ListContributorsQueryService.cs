using CleanArchBlog_crud.UseCases.Contributors;
using CleanArchBlog_crud.UseCases.Contributors.List;
using Microsoft.EntityFrameworkCore;

namespace CleanArchBlog_crud.Infrastructure.Data.Queries;
